...
public class UpdateOrgRequest {
    ...
    public UpdateOrgRequest withRequestBody(UpdateOrgRequestBody requestBody) {
    ...
    public UpdateOrgRequest withDomain(String domain) {
        this.domain = domain;
        return this;
    }
    ...
    public UpdateOrgRequest withEmailDomains(String emailDomains) {
    ...
    public UpdateOrgRequest withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateOrgRequest withNotificationEmailAddress(String notificationEmailAddress) {
    ...
    public UpdateOrgRequest withObservatoryUrl(String observatoryUrl) {
    ...
    public UpdateOrgRequest withSlackWebhook(String slackWebhook) {
    ...
    public UpdateOrgRequest withSubscriptionTier(ai.whylabs.WhyLabs.models.shared.SubscriptionTier subscriptionTier) {
        this.subscriptionTier = subscriptionTier;
        return this;
    }
    
    public UpdateOrgRequest(@JsonProperty("RequestBody") UpdateOrgRequestBody requestBody, @JsonProperty("name") String name) {
        this.requestBody = requestBody;
        this.name = name;
  }
}
