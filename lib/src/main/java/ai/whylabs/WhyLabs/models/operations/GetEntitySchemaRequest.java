...
public class GetEntitySchemaRequest {
    ...
    public GetEntitySchemaRequest withDatasetId(String datasetId) {
    ...
    public GetEntitySchemaRequest withOrgId(String orgId) {
        this.orgId = orgId;
        return this;
    }
    
    public GetEntitySchemaRequest(@JsonProperty("dataset_id") String datasetId, @JsonProperty("org_id") String orgId) {
        this.datasetId = datasetId;
        this.orgId = orgId;
  }
}
