...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetColumnWeightsResponse res = sdk.featureWeights.getColumnWeights(req, new GetColumnWeightsSecurity("ipsum") {{
                apiKeyAuth = "";
            }});
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PutColumnWeightsRequest req = new PutColumnWeightsRequest("excepturi", "model-123", "org-123");            

            PutColumnWeightsResponse res = sdk.featureWeights.putColumnWeights(req, new PutColumnWeightsSecurity("aspernatur") {{
                apiKeyAuth = "";
            }});
